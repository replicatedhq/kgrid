...
var applicationsResource = schema.GroupVersionResource{Group: "kgrid", Version: "v1alpha1", Resource: "applications"}

var applicationsKind = schema.GroupVersionKind{Group: "kgrid", Version: "v1alpha1", Kind: "Application"}
